...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list.add(
            ModelRV(
                path = "https://yandex.ru/images/search?from=tabbar&text=Кофе",
                name = "Coffee"
            )
        )
        list.add(
            ModelRV(
                path = "https://yandex.ru/images/search?text=Салаты&from=tabbar",
                name = "Salads"
            )
        )
        ...
        list.add(
            ModelRV(
                path = "https://yandex.ru/images/search?text=Десерты&from=tabbar",
                name = "Desserts"
            )
        )
        ...
        list.add(
            ModelRV(
                path = "https://yandex.ru/images/search?text=Кофе%20в%20зёрнах&from=tabbar",
                name = "Coffee beans"
            )
        )
